...
def boar_brawl(player_score, opponent_score):
    ...
    result = abs(num_player - num_opponent) * 3
    score = result if result else 1
    return score
    # END PROBLEM 2
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    "*** YOUR CODE HERE ***"
    score = roll_dice(num_rolls,dice) if num_rolls else boar_brawl(player_score,opponent_score)
    return score
    # END PROBLEM 3
...
def sus_points(score):
    ...
    if num_factors(score) in (3,4):
        score_prime = score + 1
        while not is_prime(score_prime):
            score_prime += 1
        return score_prime
    else:
        return score
...
def play(strategy0, strategy1, update,
    ...
    if score0 < goal and score1 < goal:
        ...
        score1,score0 = play(strategy1,strategy0,update,score1,score0,dice,goal)
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy(score_player,score_opponent):
        return n
    return strategy
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    base = strategy(0,0)
    for sp in range(0,goal):
        for so in range(0,goal):
            if strategy(sp,so) != base:
                return False
    return True
    # END PROBLEM 7
